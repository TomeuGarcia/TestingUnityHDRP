...
namespace AudioInterference
{


    public class AudioInterferencePlayer : MonoBehaviour
    {
        [System.Serializable]
        public class Configuration
        {
            ...
            [SerializeField]
            public AudioVariation shortInterferenceAudioVariation = new AudioVariation(
                volumeInterval: new(0.2f, 0.3f), pitchInterval: new(1.5f, 2.0f)
            );
            [SerializeField]
            public AudioVariation waitingShortInterferenceAudioVariation = new AudioVariation(
